...
const wellnessMenu = [
  { name: 'Wellness Hub', href: '/wellness', icon: '🧘', description: 'Check-ins & self-care' },
  { name: 'Breathing Exercises', href: '/breathing', icon: '🫁', description: '45 breathing techniques' },
];
                    ...
                    >
                      <Menu.Items className="absolute left-0 z-10 mt-2 w-64 origin-top-left rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                        <div className="py-1">
                          ...
                          {wellnessMenu.map((item) => (
                            <Menu.Item key={item.name}>
                              {({ active }) => (
                                <Link
                                  to={item.href}
                                  className={clsx(
                                    'px-4 py-3 text-sm flex items-start',
                                    active ? 'bg-gray-50 text-gray-900' : 'text-gray-700'
                                  )}
                                >
